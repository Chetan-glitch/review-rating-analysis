...
import pandas as pd
def get_model():
    maildata=pd.read_csv("C:\\Users\\cheta\\Desktop\\finalproject\\maildata\\maildata.csv")
    hoteldata=pd.read_csv("C:\\Users\\cheta\\Desktop\\finalproject\\hotel\\train.csv")
    moviedata=pd.read_csv("C:\\Users\\cheta\\Desktop\\finalproject\\movie data\\moviedata.csv")
